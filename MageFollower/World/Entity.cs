...
namespace MageFollower.World
{
    public class Entity
    {
        ...
        /// </summary>
        public Skill Transporting = new Skill(SkillType.Transporting, 0);
        ...
        /// </summary>
        public Skill Reading = new Skill(SkillType.Reading, 0);
        ...
        /// </summary>
        /// 
        public Skill Speech = new Skill(SkillType.Speech, 0);
        ...
        /// </summary>
        public Skill Entertainment = new Skill(SkillType.Entertainment, 0);
        //Combat 
        ...
        /// </summary>
        public Skill Defence = new Skill(SkillType.Defence, 0);
        ...
        public bool AddXpToSkill(XpToTarget xpToTarget, out bool didLevel)
        {
            if(skillFields == null)
            {
            ...
            {
                didLevel = ((Skill)skillFields[xpToTarget.Level].GetValue(this)).AddXp(xpToTarget.Xp) > 0;
                return true;
            }
            didLevel = false;
            return false;
